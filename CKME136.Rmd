...
# Combining overdoses and prescribers file

overdoses_prescribers_combined <- c(overdoses, prescribers)

# I will need to develop a linear regression, lm, where I want to predict overdoses$Death from opioid prescriptions by state (Prescribers file - I will have to go back and filter opioid prescriptions by state and combine across all 11 opioids - to give overall #s of opioids per state)
